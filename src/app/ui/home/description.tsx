...
export const Description = () => {
  return (
    <section className="bg-gradient-radial-center from-primary-400/50 to-primary-400 dark:from-primary-800 dark:to-primary-900">
      <div
        className={`${CONTAINER} flex flex-col-reverse items-center py-20 md:flex-row md:py-36`}
      >
        <div className="md:w-1/2">
          {skills.map((skill, index) => (
            <div
              key={index}
              className="mb-2 bg-primary-300 p-10 shadow-none transition-all hover:z-10 hover:-translate-y-1 hover:shadow-2xl hover:shadow-black/50 dark:bg-primary-800 dark:shadow-white"
            >
